         ...
         String dquery="select * from oprod";
          ...
          while(rs.next())
          {
               ...
               <td><%=rs.getString(5)%></td>
                <td><a href="UpdateProductfAction.jsp?val=<%=rs.getString(1)%>">Click me for update</a></td>
                  <td><a href="DeleteProductAction.jsp?val=<%=rs.getString(2)%>">Click me for Delete</a></td>
            </tr>
          <% 
          }
