...
<body>
  ...
  <section class="news-area bg-gray section-padding-100-0" style="background-color: #32be8f">
    ...
    <div class="container">
		...
		<form action="addtr.jsp">
                     <div>
                            <label for="recipient-name" class="col-form-label">Trainer Name</label>
                            <input type="text" name="trainingname" required="" class="form-control" >
                        </div>
                        <div class="form-group">
                            <label for="message-text" class="col-form-label">Training Name</label>
                            <input type="text" name="trainername" required="" class="form-control" >
                        </div>
                        <div class="form-group">
                            <label for="message-text" class="col-form-label">Duration</label>
                            <input type="number" name="dur" required="" class="form-control" >
	                </div>
                    <div class="form-group">
                            <label for="message-text" class="col-form-label">Date From</label>
                            <input type="date" name="dfro" required="" class="form-control" >
	                </div>
                       <div class="form-group">
                            <label for="message-text" class="col-form-label">Date To</label>
                            <input type="date" name="dto" required="" class="form-control" >
 	                </div>
                        ...
                        <div class="form-group">
                            <label for="message-text" class="col-form-label">About Training</label>
                            <textarea input type="text" name="about" required="" class="form-control" ></textarea>
 	                </div>
