...
<body>
  ...
  <section class="section background-dark">
    ...
    <center>
        <h1 style="color: yellowgreen">Products From Admin</h1><br>
    </center>
             
            <table  width="300px" cellpadding="900" align="center" style="width: 900px;margin-left:150px" >
            <tr>
                <th style="background-color: #00a78e">Crop  Name</th>
                <th style="background-color: #00a78e">Crop Owner Name</th>
                <th style="background-color: #00a78e">Crop Price</th>
                <th style="background-color: #00a78e">Address</th>
                <th style="background-color: #00a78e">Mobile</th>
                <th style="background-color: #00a78e">Respone</th>
        </tr>
            ...
            try
   {
       ...
       Statement st = con.createStatement();
         ...
         String dquery="select * from oprod ";
       
          ResultSet rs=st.executeQuery(dquery);
       
          while(rs.next())
          {
              alldata=rs.getString(1)+" "+rs.getString(2)+" "+rs.getString(4)+" "+rs.getString(5);
...
%>
               ...
               <td><a href="payment.jsp?val=<%=rs.getString(1)%>"><input type="submit" class="submit" value="Make Payment"></a></td>
