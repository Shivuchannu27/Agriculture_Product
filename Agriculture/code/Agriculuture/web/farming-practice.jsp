...
<head>
  ...
  <!-- Title -->
  <title>Agriculture | Farming-Practice</title>
  <!-- Favicon -->
  ...
  <div id="1s" style="" class="ex1" >
   <center>
        ...
        <h1 style="font-family:timesnewroman;color:teal;">
            <b><u>View Training  Details.
                </u></b>
        </h1><br><br>
        <table border="3px" style="margin-left: 100px;">
            <tr>
            ...
            try
   {
        Connection con = Db.getConnection();
         ...
         String dquery="select * from training";
